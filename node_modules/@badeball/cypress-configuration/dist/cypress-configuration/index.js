...
exports.resolveTestFiles = exports.resolveConfiguration = exports.determineCypressEra = exports.CypressEra = exports.UnsupportedCypressEra = exports.UnrecognizedConfigurationFileError = exports.MultipleConfigurationFilesError = exports.MissingConfigurationFileError = exports.CypressConfigurationError = void 0;
...
Object.defineProperty(exports, "UnsupportedCypressEra", { enumerable: true, get: function () { return errors_1.UnsupportedCypressEra; } });
...
function resolveConfiguration(options) {
    ...
    if (era === CypressEra.PRE_V10) {
        throw new errors_1.UnsupportedCypressEra("Unable resolve configuration of Cypress versions below v10");
    }
    else {
...
function resolveTestFiles(configuration) {
    if ("specPattern" in configuration) {
        ...
        throw new errors_1.UnsupportedCypressEra("Unable resolve test files of Cypress versions below v10");
    }
}
